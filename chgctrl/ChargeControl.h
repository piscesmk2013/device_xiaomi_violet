...
#include <vendor/xiaomi/chgctrl/1.0/IChargeControl.h>
#include <hidl/MQDescriptor.h>
#include <hidl/Status.h>

namespace vendor::xiaomi::chgctrl::implementation {
...
struct ChargeControl : public V1_0::IChargeControl {
    // Methods from ::vendor::xiaomi::chgctrl::V1_0::IChargeControl follow.
